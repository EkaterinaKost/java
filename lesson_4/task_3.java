...
public class task_3 {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Вас приветствует калькулятор!\nЗдесь вы можете произвести операции + , - , * " +
                        ...
                        ", если ввести слово 'стоп' я завершу работу");
        ...
        while (calc) {
            ...
            if (operation.equalsIgnoreCase("стоп")){
    ...
    public static String input_operation(Scanner scanner) {
        System.out.println("Введите оператор действия (+, -, *, /) или 'Отмена' или 'стоп' для выхода из калькулятора");
